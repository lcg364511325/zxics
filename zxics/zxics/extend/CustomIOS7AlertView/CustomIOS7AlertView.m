...
- (UIView *)createContainerView
{
    ...
    CGFloat dialogHeight = containerView.frame.size.height + (buttonHeight + buttonSpacerHeight) * 1 ;
...
- (void)addButtonsToView: (UIView *)container
{
    for (int i = 0; i < [buttonTitles count]; i++)
    {
        ...
        [closeButton setFrame:CGRectMake(self.containerView.bounds.size.width/2*i, container.bounds.size.height - ([buttonTitles count] - 1) * (buttonHeight + buttonSpacerHeight), self.containerView.bounds.size.width/2, buttonHeight)];
